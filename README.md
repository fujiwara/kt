...
* Fast start up time.
* Optimized output buffering: Automatic buffering when output is redirected to files or pipes for improved performance, while maintaining immediate output to terminals.
